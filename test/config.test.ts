...
const managed = ["INPUT_PATHS", "CACHE_DIR", "CONFIG_DIR", "WORKERS", "DRY_RUN", "SCAN_INTERVAL_MINUTES", "MIN_SAVINGS_PERCENT", "QSV_QUALITY", "QSV_PRESET", "QSV_DEVICE", "SONARR_URL", "SONARR_API_KEY", "RADARR_URL", "RADARR_API_KEY"];
